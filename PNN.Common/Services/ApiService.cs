...
namespace PNN.Common.Services
{
    public class ApiService : IApiService
    {
        ...
        public async Task<Response<object>> AddComment(
            string urlBase, 
            string servicePrefix, 
            string controller, 
            ...
            string accessToken)
        {
            try
            {
                ...
                var request = JsonConvert.SerializeObject(comment);
        ...
        public async Task<Response<object>> GetLastContentByUserId(
            string urlBase,
            string servicePrefix,
            string controller,
            string tokenType,
            ...
            string userId)
        {
            try
            {
                ...
                client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(tokenType, accessToken);
                var url = $"{servicePrefix}{controller}/{userId}";
                var response = await client.GetAsync(url);
                var result = await response.Content.ReadAsStringAsync();
                ...
                var property = JsonConvert.DeserializeObject<ContentResponse>(result);
                return new Response<object>
                {
                    IsSuccess = true,
                    Result = property
